...
* * **[Apple Scripting Execution with Administrator Privileges](https://github.com/elastic/detection-rules/blob/main/rules/macos/privilege_escalation_applescript_with_admin_privs.toml)**
**[Apple Scripting Execution with Administrator Privileges](https://github.com/elastic/detection-rules/blob/main/rules/macos/privilege_escalation_applescript_with_admin_privs.toml)**
* Execution with Explicit Credentials via Scripting)**
* Unusual Hour for a User to Logon)**
* Unusual Source IP for a User to Logon from)**
* [ml](https://github.com/elastic/detection-rules/tree/main/rules/ml/) / **[Rare User Logon](https://github.com/elastic/detection-rules/blob/main/rules/ml/initial_access_ml_auth_rare_user_logon.toml)**
...
* [ProofpointPOD](https://github.com/Azure/Azure-Sentinel/tree/master/Detections/ProofpointPOD/) / **[ProofpointPOD - Binary file in attachment](https://github.com/Azure/Azure-Sentinel/blob/master/Detections/ProofpointPOD/ProofpointPODBinaryInAttachment.yaml)**
* [ProofpointPOD](https://github.com/Azure/Azure-Sentinel/tree/master/Detections/ProofpointPOD/) / **[ProofpointPOD - Possible data exfiltration to private email](https://github.com/Azure/Azure-Sentinel/blob/master/Detections/ProofpointPOD/ProofpointPODDataExfiltrationToPrivateEmail.yaml)**
...
* [cloud](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/) / [azure](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/azure/) / **[Successful Authentications From Countries You Do Not Operate Out Of](https://github.com/SigmaHQ/sigma/blob/master/rules/cloud/azure/azure_ad_authentications_from_countries_you_do_not_operate_out_of.yml)**
* [cloud](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/) / [azure](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/azure/) / **[Authentications To Important Apps Using Single Factor Authentication](https://github.com/SigmaHQ/sigma/blob/master/rules/cloud/azure/azure_ad_auth_to_important_apps_using_single_factor_auth.yml)**
* [cloud](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/) / [azure](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/azure/) / **[Bitlocker Key Retrieval](https://github.com/SigmaHQ/sigma/blob/master/rules/cloud/azure/azure_ad_bitlocker_key_retrieval.yml)**
* [cloud](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/) / [azure](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/azure/) / **[Device Registration or Join Without MFA](https://github.com/SigmaHQ/sigma/blob/master/rules/cloud/azure/azure_ad_device_registration_or_join_without_mfa.yml)**
* [cloud](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/) / [azure](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/azure/) / **[Failed Authentications From Countries You Do Not Operate Out Of](https://github.com/SigmaHQ/sigma/blob/master/rules/cloud/azure/azure_ad_failed_auth_from_countries_you_do_not_operate_out_of.yml)**
* [cloud](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/) / [azure](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/azure/) / **[Guest Users Invited To Tenant By Non Approved Inviters](https://github.com/SigmaHQ/sigma/blob/master/rules/cloud/azure/azure_ad_guest_users_invited_to_tenant_by_non_approved_inviters.yml)**
* [cloud](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/) / [azure](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/azure/) / **[Azure AD Only Single Factor Authentication Required](https://github.com/SigmaHQ/sigma/blob/master/rules/cloud/azure/azure_ad_only_single_factor_auth_required.yml)**
* [cloud](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/) / [azure](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/azure/) / **[Sign-ins from Non-Compliant Devices](https://github.com/SigmaHQ/sigma/blob/master/rules/cloud/azure/azure_ad_sign_ins_from_noncompliant_devices.yml)**
* [cloud](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/) / [azure](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/azure/) / **[Sign-ins by Unknown Devices](https://github.com/SigmaHQ/sigma/blob/master/rules/cloud/azure/azure_ad_sign_ins_from_unknown_devices.yml)**
* [cloud](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/) / [azure](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/azure/) / **[Users Added to Global or Device Admin Roles](https://github.com/SigmaHQ/sigma/blob/master/rules/cloud/azure/azure_ad_users_added_to_device_admin_roles.yml)**
* [cloud](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/) / [azure](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/azure/) / **[Application Using Device Code Authentication Flow](https://github.com/SigmaHQ/sigma/blob/master/rules/cloud/azure/azure_app_device_code_authentication.yml)**
* [cloud](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/) / [azure](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/azure/) / **[Applications That Are Using ROPC Authentication Flow](https://github.com/SigmaHQ/sigma/blob/master/rules/cloud/azure/azure_app_ropc_authentication.yml)**
...
* [cloud](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/) / [azure](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/azure/) / **[User State Changed From Guest To Member](https://github.com/SigmaHQ/sigma/blob/master/rules/cloud/azure/azure_guest_to_member.yml)**
...
* [cloud](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/) / [azure](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/azure/) / **[PIM Approvals And Deny Elevation](https://github.com/SigmaHQ/sigma/blob/master/rules/cloud/azure/azure_pim_activation_approve_deny.yml)**
...
* [cloud](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/) / [azure](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/azure/) / **[Users Authenticating To Other Azure AD Tenants](https://github.com/SigmaHQ/sigma/blob/master/rules/cloud/azure/azure_users_authenticating_to_other_azure_ad_tenants.yml)**
* [cloud](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/) / [azure](https://github.com/SigmaHQ/sigma/tree/master/rules/cloud/azure/) / **[Password Reset By User Account](https://github.com/SigmaHQ/sigma/blob/master/rules/cloud/azure/azure_user_password_change.yml)**
...
* [windows](https://github.com/SigmaHQ/sigma/tree/master/rules/windows/) / [powershell](https://github.com/SigmaHQ/sigma/tree/master/rules/windows/powershell/) / [powershell_module](https://github.com/SigmaHQ/sigma/tree/master/rules/windows/powershell/powershell_module/) / **[Suspicious Computer Machine Password by PowerShell](https://github.com/SigmaHQ/sigma/blob/master/rules/windows/powershell/powershell_module/posh_pm_susp_reset_computermachinepassword.yml)**
