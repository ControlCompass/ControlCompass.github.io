...
* [sigma/rules/cloud/gcp/gcp_full_network_traffic_packet_capture.yml](https://github.com/SigmaHQ/sigma/blob/master/rules/cloud/gcp/gcp_full_network_traffic_packet_capture.yml)
