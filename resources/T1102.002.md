...
* [network](https://github.com/SigmaHQ/sigma/tree/master/rules/network/) / **[Telegram Bot API Request](https://github.com/SigmaHQ/sigma/blob/master/rules/network/net_susp_telegram_api.yml)**
