...
* [web](https://github.com/SigmaHQ/sigma/tree/master/rules/web/) / **[Multiple Suspicious Resp Codes Caused by Single Client](https://github.com/SigmaHQ/sigma/blob/master/rules/web/web_multiple_suspicious_resp_codes_single_source.yml)**
