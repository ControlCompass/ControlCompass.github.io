...
* [sigma/rules/macos/process_creation/proc_creation_macos_gui_input_capture.yml](https://github.com/SigmaHQ/sigma/blob/master/rules/macos/process_creation/proc_creation_macos_gui_input_capture.yml)
* [sigma/rules/windows/image_load/image_load_uipromptforcreds_dlls.yml](https://github.com/SigmaHQ/sigma/blob/master/rules/windows/image_load/image_load_uipromptforcreds_dlls.yml)
* [sigma/rules/windows/process_creation/proc_creation_win_mouse_lock.yml](https://github.com/SigmaHQ/sigma/blob/master/rules/windows/process_creation/proc_creation_win_mouse_lock.yml)
