...
* [car/analytics/CAR-2013-09-003.yaml](https://github.com/mitre-attack/car/blob/master/analytics/CAR-2013-09-003.yaml)
...
* [sigma/rules/windows/builtin/security/win_petitpotam_network_share.yml](https://github.com/SigmaHQ/sigma/blob/master/rules/windows/builtin/security/win_petitpotam_network_share.yml)
* [sigma/rules/windows/builtin/security/win_petitpotam_susp_tgt_request.yml](https://github.com/SigmaHQ/sigma/blob/master/rules/windows/builtin/security/win_petitpotam_susp_tgt_request.yml)
...
* [security_content/detections/endpoint/petitpotam_network_share_access_request.yml](https://github.com/splunk/security_content/blob/develop/detections/endpoint/petitpotam_network_share_access_request.yml)
