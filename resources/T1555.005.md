...
* [sigma/rules/windows/create_remote_thread/sysmon_password_dumper_keepass.yml](https://github.com/SigmaHQ/sigma/blob/master/rules/windows/create_remote_thread/sysmon_password_dumper_keepass.yml)
