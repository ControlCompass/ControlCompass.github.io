...
$(document).ready(function(){
	...
	$('#process-data').click(function(){
        ...
        for (item in inParse.techniques) {
        	...
        	arrayTech_score.push(inParse.techniques[item])
        };
        ...
        for (allTech_obj in allTech) {
            for (arrayTech_score_obj in arrayTech_score) {
                if (allTech[allTech_obj].techID == arrayTech_score[arrayTech_score_obj].techniqueID) {
                    allTech[allTech_obj].intel_score = arrayTech_score[arrayTech_score_obj].score
                }
            }
        }
        ...
        window.location.href = '#cvc-output_header'
	...
	$('#techLow').click(function(){
        ...
        allTech.sort((a, b) => a.intel_score - b.intel_score);
	...
	$('#techHigh').click(function(){
        ...
        allTech.sort((a, b) => b.intel_score - a.intel_score);
