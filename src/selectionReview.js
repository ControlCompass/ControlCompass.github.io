...
//        }
    ...
    for (var y = 0; y < adversary_list2.length; y++) {
        adversary_list2_string += '<br><input type="radio" class="category_selection" name="category_selection" style="margin-right:0.3rem" id="' + adversary_list2[y] + '_radio" onclick="loadHeatmap1()" value="' + adversary_list2[y] + '"><label for="' + adversary_list2[y] + '_radio">' + adversary_list2[y] + ' (All adversaries)' + '</label>'
    }
...
//        }
        ...
        for (var y = 0; y < adversary_list.length; y++) {
            adversary_list_string += '<br><input type="radio" class="adversary_selection" name="adversary_selection" style="margin-right:0.3rem" id="' + adversary_list[y].mitre_attack_name + '_radio" onclick="loadHeatmap2()" value="' + adversary_list[y].mitre_attack_name + '"><label for="' + adversary_list[y].mitre_attack_name + '_radio">' + adversary_list[y].merged_name + '</label>'
        }
